...
async function submitCommunity(event, wxContext) {
  ...
  const openid = wxContext.OPENID
  const cleanData = pickStringFields(event, ['name', 'province', 'city', 'communityType', 'communityTypeOther', 'ageRange', 'ageRangeOther', 'officialUrl', 'participationNote', 'feeNote', 'sourceNote', 'recommendationNote'])
