...
const RATE_LIMIT_ONLY_ALLOWED_ACTIONS = new Set([])
...
const rateLimitMissingHandler = diff(rateLimitedActions, new Set([...appServiceActions, ...RATE_LIMIT_ONLY_ALLOWED_ACTIONS]))
...
printList('rate-limit config entries without appService handler:', rateLimitMissingHandler)
