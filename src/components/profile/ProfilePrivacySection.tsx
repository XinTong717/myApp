...
type Props = {
  ...
  // Legacy storage/API field name. Product semantics are now "expanded profile visibility":
  // whether logged-in users with completed profiles can see contact note and role-specific details.
