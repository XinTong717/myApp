  ...
  return (
    <View style={{ minHeight: '100vh', backgroundColor: palette.bg, padding: '16px', boxSizing: 'border-box' }}>
      ...
      <Section title='2. 运营主体与联系方式'>
        <BodyText>
          本产品由杭州可雀科技有限责任公司运营。若你需要查询、更正、删除个人信息，撤回公开展示，或反馈隐私与安全问题，可以通过邮箱 504302201@qq.com 联系我们，也可以优先使用小程序内现有入口处理资料修改、地图展示和联络权限设置。
        </BodyText>
      </Section>
      ...
      <Section title='9. 你的权利'>
        <BodyText>
          你可以在【我的】页查看、修改、补充或清空你主动填写的资料，也可以控制是否出现在地图上、是否接收联络请求。若你希望进一步删除信息、停止展示、撤回授权或反馈隐私问题，可以通过产品内现有入口或发送邮件至 504302201@qq.com 联系我们。我们会在核验身份和请求合理性后处理。
        </BodyText>
      </Section>
