  ...
  return (
    <AppPage>
      <View style={{ marginBottom: space(4) }}>
        <Text className='text-title text-color-main'>隐私政策</Text>
      ...
      <Section title='3. 我们会收集哪些信息'>
        <BodyText>你主动填写的信息可能包括：显示名、身份、所在省市、个人简介、公开渠道、添加备注说明，以及你选择提供的家庭教育关注信息或教育服务信息。为实现安全功能，我们还会处理拉黑或静音关系、举报记录及相关时间信息。为实现风险控制、内容安全和故障排查，我们也会处理必要的操作时间、请求标识、内容安全校验结果和云函数处理日志。</BodyText>
      </Section>

      <Section title='4. 我们如何使用这些信息'>
        <BodyText>我们使用这些信息提供地图浏览、学习社区信息展示、活动查看、成员目录浏览、资料保存、信息纠错处理、内容安全校验、举报处理、管理员审核、故障排查与风险控制等功能。公开渠道和添加备注仅用于成员目录展示，平台不提供私信、好友申请、站内撮合或双边请求服务。</BodyText>
      </Section>

      <Section title='5. 哪些信息会公开展示'>
        <BodyText>你选择出现在地图上时，可能公开展示的信息包括：显示名、身份、省市、简介以及你与本教育生态的关系说明。地图位置仅用于近似分布浏览，不应被理解为精确住址。公开渠道、添加备注、家庭教育关注信息和教育服务内容，仅对已登录并完成个人资料的用户可见；你也可以在【我的】页关闭扩展公开资料可见性。</BodyText>
      </Section>
