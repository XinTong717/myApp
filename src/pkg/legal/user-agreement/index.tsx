  ...
  return (
    <View style={{ minHeight: '100vh', backgroundColor: palette.bg, padding: '16px', boxSizing: 'border-box' }}>
      ...
      <Section title='1. 协议范围'>
        <BodyText>
          本协议适用于你使用杭州可雀科技有限责任公司运营的可雀小程序提供的学习社区浏览、活动查看、同路人地图、资料填写、联络请求、信息提交与纠错等功能。你使用本产品，即表示你已阅读、理解并同意本协议。若你对本协议、隐私或安全处理有疑问，可以通过邮箱 xtong717@gmail.com 联系我们。
        </BodyText>
      </Section>

      <Section title='2. 账号与使用资格'>
        <BodyText>
          本产品当前仅面向18周岁及以上用户。你提交资料或使用联络、提交、纠错等互动功能，即表示你确认自己已满18周岁，并确保提交的信息真实、准确、合法。若你代表家庭、组织或团队使用本产品，应确保你有权提交相关信息，尤其不得未经授权提交他人的私人联系方式或可识别未成年人的敏感细节。未成年人不应自行注册、填写资料或发起联络请求。
        </BodyText>
      </Section>
      ...
      <Section title='4. 同路人联络规则'>
        <BodyText>
          同路人功能用于帮助具有相近教育探索需求的成年人建立低风险初步联系。你应尊重对方意愿，不得骚扰、诱导、收集或滥用他人联系方式。对方拒绝、静音或拉黑后，请停止继续联系。任何线下见面、付费合作、教育服务或家庭相关安排，都应由你自行核验并谨慎决策。
        </BodyText>
      </Section>
      ...
      <Section title='6. 平台管理'>
        <BodyText>
          为维护社区秩序与用户安全，我们可能对内容进行安全审核、隐藏、删除、限制展示，或对异常行为采取限制使用、暂停联络、拉黑、记录举报等措施。若你认为处理有误，可以通过产品内入口或发送邮件至 xtong717@gmail.com 反馈。
        </BodyText>
      </Section>

      <Section title='7. 风险自担'>
        <BodyText>
          通过本产品获取的信息、建立的联系或参与的线下活动，均需要你基于自身判断谨慎决策。涉及未成年人、线下见面、付费活动、长期项目、住宿交通、医疗心理、资质承诺或人身安全时，请额外核验并采取必要保护措施。可雀不是学校资质认证机构、活动安全担保方或交易担保方。
        </BodyText>
      </Section>
