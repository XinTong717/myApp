  ...
  return (
    <View style={{ minHeight: '100vh', backgroundColor: palette.bg, padding: '16px', boxSizing: 'border-box' }}>
      ...
      <Section title='1. 协议范围'>
        <BodyText>
          本协议适用于你使用杭州可雀科技有限责任公司运营的可雀小程序提供的学习社区浏览、活动查看、同路人地图、资料填写、联络请求、信息提交与纠错等功能。你使用本产品，即表示你已阅读、理解并同意本协议。若你对本协议、隐私或安全处理有疑问，可以通过邮箱 504302201@qq.com 联系我们。
        </BodyText>
      </Section>
      ...
      <Section title='6. 平台管理'>
        <BodyText>
          为维护社区秩序与用户安全，我们可能对内容进行安全审核、隐藏、删除、限制展示，或对异常行为采取限制使用、暂停联络、拉黑、记录举报等措施。若你认为处理有误，可以通过产品内入口或发送邮件至 504302201@qq.com 反馈。
        </BodyText>
      </Section>
