  ...
  return (
    <View style={{ minHeight: '100vh', backgroundColor: palette.bg, padding: '16px', boxSizing: 'border-box' }}>
      ...
      <Section title='1. 协议范围'>
        <BodyText>
          本协议适用于你使用杭州可雀科技有限责任公司运营的可雀小程序提供的学习社区浏览、活动查看、同路人地图、资料填写、联络请求、信息提交与纠错等功能。你使用本产品，即表示你已阅读、理解并同意本协议。
        </BodyText>
      </Section>
      ...
      <Section title='7. 风险自担'>
        <BodyText>
          通过本产品获取的信息、建立的联系或参与的线下活动，均需要你基于自身判断谨慎决策。涉及未成年人、线下见面、付费活动、长期项目、住宿交通、医疗心理、资质承诺或人身安全时，请额外核验并采取必要保护措施。
        </BodyText>
      </Section>
