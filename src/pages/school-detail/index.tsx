...
function SchoolContent(props: {
  ...
  return (
    <>
      ...
      <AppInfoRow label='公开说明' value={school.xuji_note} emphasis />
      <AppInfoRow label='参与前了解' value={school.residency_req} emphasis />
      <AppInfoRow label='参与方式参考' value={school.admission_req} emphasis />
      <AppInfoRow label='参考费用' value={school.fee} emphasis />
      <AppInfoRow label='相关说明' value={school.output_direction} emphasis />
